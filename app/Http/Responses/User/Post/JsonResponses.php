...
class JsonResponses
{
    ...
    public function invalidPostPossession()
    {
        return response()->json(["status" => "error", "message" => __('message.invalidPossession', ['model' => __('message.model.post')])], Response::HTTP_UNPROCESSABLE_ENTITY);
    }
}
