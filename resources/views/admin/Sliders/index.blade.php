            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-semibold leading-6 text-gray-900">افزودن {{ __('Slider') }}</h3>
                        <p class="mt-1 text-sm text-gray-600">ساخت {{ __('Sliders') }}‌ در سایت از
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <form method="POST" action="{{ route('admin.sliders.store') }}" class="space-y-3"
    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-4 sm:px-0 mb-5">
                <h3 class="text-lg font-semibold leading-6 text-gray-900">لیست {{ __('Sliders') }}</h3>
            </div>
            <table
                ...
                <thead class="bg-gray-50 sm:rounded-t-lg relative">
                    <tr class="relative">
                        ...
                        <th scope="col" class="text-right font-bold text-sm py-2 px-2">نام {{ __('Slider') }}</th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse ($sliders as $slider)
                        <tr>
                            <td class="font-medium text-sm py-4 px-5">{{ $slider->id }}</td>
                            <td class="font-medium text-sm py-4 px-2">
                                <img src="{{ $slider->getFirstMediaUrl() }}" alt="" class="h-12">
                            </td>
                            <td class="font-medium text-sm py-4 px-2">{{ $slider->name }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $slider->lang }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $slider->priority }}</td>
                            <td class="font-medium text-sm py-4 px-2">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-2">
                                                                    <p class="text-sm leading-6 text-gray-500">
                                                                        آیا از حذف این {{ __('Slider') }} مطمئن هستید؟
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
