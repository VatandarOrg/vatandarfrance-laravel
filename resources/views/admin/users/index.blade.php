<x-app-layout>
    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-4 sm:px-0 mb-5 flex items-center justify-between">
                <h3 class="text-lg font-semibold leading-6 text-gray-900">لیست {{ __('users') }}</h3>
                <a href="{{ route('admin.users.create') }}"
                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1 -mr-1.5" fill="none"
            ...
            <div class="relative overflow-auto shadow-md sm:rounded-lg border bg-white mb-3">
                <table class="w-full min-w-full max-w-full overflow-auto divide-y divide-gray-300 mb-4">
                    <thead class="bg-gray-50 sm:rounded-t-lg relative">
                        <tr class="relative">
                            <th scope="col" class="text-right font-bold text-sm py-2 px-5">شناسه</th>
                            <th scope="col" class="text-right font-bold text-sm py-2 px-2">نام {{ __('User') }}
                            </th>
                            <th scope="col" class="text-right font-bold text-sm py-2 px-2">ایمیل </th>
                            <th scope="col" class="text-right font-bold text-sm py-2 px-2">موبایل </th>
                            <th scope="col" class="text-right font-bold text-sm py-2 px-2">اشتراک</th>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse ($users as $user)
                            <tr>
                                <td class="font-medium text-sm py-4 px-5">{{ $user->id }}</td>
                                <td class="font-medium text-sm py-4 px-2">{{ $user->name }}</td>
                                <td class="font-medium text-sm py-4 px-2">{{ $user->email }}</td>
                                <td class="font-medium text-sm py-4 px-2">{{ $user->mobile }}</td>
                                ...
                                <td class="font-medium text-sm py-4 px-2">
                                    <div class="flex space-x-2 space-x-reverse">
                                        <a href="{{ route('admin.users.show', $user->id) }}"
                                            class="flex items-center content-center justify-center text-blue-500 bg-blue-100 h-7 w-7 rounded">
