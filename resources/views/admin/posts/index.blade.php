            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-semibold leading-6 text-gray-900">افزودن {{ __('Post') }}</h3>
                        <p class="mt-1 text-sm text-gray-600">ساخت {{ __('posts') }}‌در سایت از
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <form method="POST" action="{{ route('admin.posts.store') }}" class="space-y-3"
            ...
            <table
                ...
                <thead class="bg-gray-50 sm:rounded-t-lg relative">
                    <tr class="relative">
                        ...
                        <th scope="col" class="text-right font-bold text-sm py-2 px-5">تصویر</th>
                        <th scope="col" class="text-right font-bold text-sm py-2 px-2">عنوان {{ __('Post') }}
                        </th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse ($posts as $post)
                        <tr>
                            <td class="font-medium text-sm py-4 px-5">{{ $post->id }}</td>
                            <td class="font-medium text-sm py-4 px-5"> <img src="{{ $post->getFirstMediaUrl() }}"
                                    alt="" class="h-12">
                            </td>
                            <td class="font-medium text-sm py-4 px-2">{{ $post->title }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $post->section->name }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $post->priority }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $post->lang }}</td>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-2">
                                                                    <p class="text-sm leading-6 text-gray-500">
                                                                        آیا از حذف این {{ __('Post') }} مطمئن هستید؟
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
