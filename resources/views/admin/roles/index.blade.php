            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-semibold leading-6 text-gray-900">افزودن نقش</h3>
                        <p class="mt-1 text-sm text-gray-600">ساخت نقش‌ها در سایت از
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <form method="POST" action="{{ route('admin.roles.store') }}">
                                        ...
                                        <div>
                                            <x-label for="name" value="نام نقش" />
    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="px-4 sm:px-0 mb-5">
                <h3 class="text-lg font-semibold leading-6 text-gray-900">لیست نقش‌ها</h3>
            </div>
            ...
            <table
                ...
                <thead class="bg-gray-50 sm:rounded-t-lg relative">
                    <tr class="relative">
                        ...
                        <th scope="col" class="text-right font-bold text-sm py-2 px-2">نام نقش</th>
                        <th scope="col" class="text-right font-bold text-sm py-2 px-2">دسترسی ها</th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse ($roles as $role)
                        <tr>
                            <td class="font-medium text-sm py-4 px-5">{{ $role->id }}</td>
                            <td class="font-medium text-sm py-4 px-2">{{ $role->name }}</td>
                            <td class="font-medium text-sm py-4 px-2">
                                @foreach ($role->permissions as $permission)
                                    <div>{{ __($permission->name) }}</div>
                                @endforeach
                            </td>
                            <td class="font-medium text-sm py-4 px-2">
